...
<body>
    ...
    <?php
        ...
        if (isset($_REQUEST['submit'])) {
            ...
            {
                echo "<div class='form'>
                      <h3>You updated a fish successfully.</h3><br/>
            ...
            {
                echo $result . "<div class='form'>
                      <h3>Required fields are missing.</h3><br/>
                      <p class='link'>Click here to <a href='editfish.php'>try again</a> again.</p>
                      </div><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>";
            }
        } else {
    ?>
    ...
    <nav class="sticky navbar navbar-expand-lg">
        ...
        <form class="form" action="" method="post" enctype="multipart/form-data">
            <h1 class="login-title">Edit Fish</h1> <!-- form title -->
            <input type="text" class="login-input" name="species" value='<?= $row['species'] ?>' style="width:100%;" required />
            <label>Length</label><br>
            <input type="number" class="login-input" name="fishlength" min="1" max="99" value='<?= $row['fishlength'] ?>' style="width:100%;" required />
            <label>Weight</label>
            <input type="number" class="login-input" name="fishweight" min="1" max="99" value='<?= $row['fishweight'] ?>' style="width:100%;" required />
            <label>Location</label>
            <select style="width:100%;" name="locations">
              <option value="<?= $row['locations'] ?>"><?= $row['locations'] ?></option>
            ...
            <input type="text" name="notes" value='<?= $row['notes'] ?>' style="width:100%;" required />

            <br />

            <div>
              Upload Picture <input type="file" value="<?= $row['images'] ?>" name="fileToUpload" style="padding-top:2px;" required />
            </div>
