...
//  5) Return results if needed.
    ...
    public function addUser($user, $password) 
    {
        ...
        $stmt = $userTable->prepare("INSERT INTO adminusers SET userName = :user, userPassword = :pwd, userSalt = :pwd");
    ...
    public function validateCredentials($userName, $password)
    {
        ...
        $stmt = $userTable->prepare("SELECT userPassword, userSalt FROM adminusers WHERE userName =:userName");
